...
$rooms = $conn->query("SELECT * FROM rooms WHERE hotel_id = $hotel_id");
?>
                    ...
                    <?php while ($room = $rooms->fetch_assoc()): ?>
                        <div class="col-md-4">
                            <div class="room-card">
                                ...
                                <p class="mb-1"><strong>Room Type:</strong> <?= isset($room['room_type']) ? htmlspecialchars($room['room_type']) : 'N/A' ?></p>
                                <p class="mb-1"><strong>Capacity:</strong> <?= isset($room['max_guests']) ? (int)$room['max_guests'] : 'N/A' ?> persons</p>
                                <p class="mb-1"><strong>Price:</strong> <span class="text-success">
                                    <?= isset($room['price']) ? number_format($room['price'], 2) . ' Ks' : 'N/A' ?></span>
                                </p>
